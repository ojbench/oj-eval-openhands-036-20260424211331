...
def main():
    ...
    submit_parser = subparsers.add_parser("submit", help="Submit code or current Git repo")
    ...
    submit_parser.add_argument("--language", type=str, required=False,
                               help="Programming language (e.g., cpp, c, python). If omitted, submit current Git repo")
    submit_parser.add_argument("--code-file", type=str, required=False,
                               help="Path to the source code file. If omitted, submit current Git repo")
    ...
    if args.command == "submit":
        if args.code_file and args.language:
            try:
            ...
            try:
                ...
                print("Error: Failed to get git remote URL. Ensure this is a Git repo and remote 'origin' is set.")
                exit(1)
